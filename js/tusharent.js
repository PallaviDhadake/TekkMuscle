...
//Social Media Share Basic Popup box
function basicPopup(url) {popupWindow = window.open(url, 'popUpWindow', 'height=500,width=500,left=100,top=100,resizable=yes,scrollbars=yes,toolbar=yes,menubar=no,location=no,directories=no, status=yes'); }
function setSocialUrl() {
    document.getElementById("fbAnch").setAttribute("href", "https://www.facebook.com/sharer.php?u=" + window.location.href);
    document.getElementById("twAnch").setAttribute("href", "https://twitter.com/intent/tweet?url=" + window.location.href);
    //document.getElementById("linAnch").setAttribute("href", "https://www.linkedin.com/shareArticle?mini=true&url=" + window.location.href);
}